...
//  AllPatterns
//
//  Created by Austin's Macbook Pro M3 on 11/11/24.
//
...
private class Client {
    ...
    /// declared in the base Component class, the client cxode can work with both
...
private class CompositeConceptual: XCTestCase {
